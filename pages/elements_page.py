...
class WebTablePage(BasePage):
    ...
    def click_all_option_rows(self):
        ...
        """
        row_list = self.element_are_visible(self.locators.ROW_LIST)
        data = []
    ...
    def fill_one_field(self, key=None):
        """Заполняет одно выбранное или случайное поле.
